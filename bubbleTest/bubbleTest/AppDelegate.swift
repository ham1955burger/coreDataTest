...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "bubbleTest")
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "bubbleTest", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("bubbleTest.sqlite")
...
//            error = NSError(domain: "YOUR_ERROR_DOMAIN", code: 9999, userInfo: dict)
    ...
    func saveContext(checkError:@escaping (NSError?) -> ()) {
//        let context = persistentContainer.viewContext
    ...
    func deleteAllData(entity: String, checkError:@escaping (NSError?) -> ()) {
